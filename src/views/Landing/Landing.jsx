...
const StyledContainer = styled(Box)`
  background: conic-gradient(
    from 91.9deg at 38.87% 20.52%,
    rgba(0, 201, 202, 0.53) -67.18deg,
    rgba(14, 70, 120, 0.38) 76.02deg,
    rgba(18, 37, 99, 0.850441) 124.96deg,
    rgba(21, 9, 81, 0.85) 166.87deg,
    rgba(0, 201, 202, 0.53) 292.82deg,
    rgba(14, 70, 120, 0.38) 436.02deg
  );
  > div:nth-child(1) {
    width: 100%;
    max-width: 1400px;
